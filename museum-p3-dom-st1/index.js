...
console.log('Hello! Самооценка - 150 из 150. (156 из 160)');
...
console.log('Хоткеи видео доступны при фокусе на плеере или в fullscreen');
console.log('Выполнены все пункты кроме следующих: ');
console.log('Не выполненные/не засчитанные пункты(-2 каждый): ');
console.log('Этот пункт не реализован - 1) если внутри слайда проигрывается видео с YouTube, клик по стрелке перелистывания слайдов или клик по буллету останавливает проигрывание видео ');

console.log('Частично выполненные пункты (-1 каждый): ');
console.log('Видео останавливается по кнопке пауза, но при старте другого видео автоматом на паузу не ставится - 1) если видео с YouTube проигрывается, клик по кнопке Pause останавливает его проигрывание. Также проигрывание видео останавливается, если кликнуть по другому слайду или кнопке Play в центре другого слайда. В указанной ситуации другое видео должно запуститься, а текущее остановиться. Невозможно проигрывание нескольких YouTube видео одновременно');
console.log('Возможность перелистывания по буллетам есть, но основное видео меняется только по нажатию на стрелки слайдера 2) есть возможность перелистывания слайдов кликами по буллетам (кружочки внизу слайдера), при этом также меняется основное видео');